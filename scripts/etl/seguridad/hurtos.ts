...
const DATASET_ID = "jhnf-9iii";

export async function loadHurtos(): Promise<number> {
  log("info", "Loading hurtos a personas from datos.gov.co...");
  ...
  return loadIndicator({
    ...
    descripcion: "Numero total de hurtos a personas reportados por territorio y periodo",
    unidad_medida: "casos",
    periodicidad: "anual",
    ...
    ficha_tecnica: {
      ...
      metodologia: "Conteo de registros de hurtos a personas agrupados por anio y comuna",
    },
